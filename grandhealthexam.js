...
function convertToPDF(v0,v1,s1,s2,s3,s4,s5,s6,s7,s8){
	...
	for (i=v0;i<v1;i++){
		...
		if (document.getElementById('checkreport').checked){
			...
			reportcontent+='<tr><td style="text-align: center;">'+t0+'</td><td style="text-align: center;">貧血</td><td>1. 貧血原因十分多樣，需針對個別原因進行處理，以下提供兩個常見類型的衛教，若仍有疑問可前往血液腫瘤科進行諮詢。<br> a.若為有月經婦女最常見原因為缺鐵性貧血，可多補充富含鐵質食物，也可至婦產科檢查是否子宮問題導致經血量較大。<br> b.地中海型貧血屬於遺傳性的貧血，佔台灣總人口數的6至8%左右，可在孕前做健康檢查，避免雙方皆是帶因者，而生出重症地中海型貧血的孩子。</td></tr>';
			...
			reportcontent+='<tr><td style="text-align: center;">'+t0+'</td><td style="text-align: center;">尿酸過高</td><td>1. 生活型態調整：多攝取水份，避免吃高普林食物(如內臟類、帶殼海鮮、濃湯等)、高果糖食物(大量水果或含糖飲料)及避免喝酒。<br>2. 若有發作頻繁痛風可與醫師討論是否降尿酸治療。<br>3. 生活型態調整後3~6個月請再次抽血驗尿追蹤(需空腹)。</td></tr>';
			...
			reportcontent+='<tr><td style="text-align: center;">'+t0+'</td><td style="text-align: center;">B型肝炎</td><td rowspan="2">1. 阻斷傳染途徑：避免共用針頭、牙刷、刮鬍刀等<br>2. 健康飲食及多運動，保持良好的生活習慣，勿飲酒。<br>3. B型肝炎帶原者: 每半年定期肝膽腸胃科腹部超音波及抽血檢查。<br>4. C型肝炎抗體陽性: 表示曾經C肝感染過，需加驗C肝病毒量，若仍有C肝病毒，請接受C肝抗病毒藥物，治癒成功率達97%。</td></tr>';
			if (dat[44].includes('陽性')){
				t0="■";
			} else {
				t0="□";
			...
			reportcontent+='<tr><td style="text-align: center;">'+t0+'</td><td style="text-align: center;">甲型胎兒蛋白偏高</td><td>甲型胎兒蛋白(α-Fetoprotein)是一種α-1球蛋白，由胎兒的卵黃囊、腸胃道及肝臟分泌，成人則多由肝臟分泌，許多肝病皆可能伴隨甲型胎兒蛋白升高，80-90%的肝細胞癌病人血清中甲型胎兒蛋白有升高現象，檢查結果偏高建議至肝膽腸胃科接受腹部超音波檢查。</td></tr>';
			if (dat[59]=="陽性"){
				t0="■";
			} else {
				t0="□";
			...
			reportcontent+='<tr><td style="text-align: center;">□</td><td style="text-align: center;">其他</td><td><br><br><br><br></td></tr></table></div>';
			
			reportcontent+='<br><br>'
			
			reportcontent+='<div class="suggestion_title" style="text-align: left;">若有其他疑問歡迎諮詢</div>';
			reportcontent+='<div class="suggestion_title" style="text-align: left;">'+clinicname+'服務時間如下</div>';
			reportcontent+=addopdtable();
			reportcontent+='<div class="suggestion_title" style="text-align: left;">'+clinicname+' 電話:'+clinicphone+'</div>';
			reportcontent+='<div class="suggestion_title" style="text-align: left;">'+clinicname+' 地址:'+clinicaddress+'</div>';
